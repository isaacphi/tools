...
var disambiguate = map[string]adjust{
	"CodeActionTriggerKind":        {prefix: "CodeAction", suffix: ""},
	"CompletionItemKind":           {prefix: "", suffix: "Completion"},
	"CompletionItemTag":            {prefix: "Compl", suffix: ""},
	"DiagnosticSeverity":           {prefix: "Severity", suffix: ""},
	"DocumentDiagnosticReportKind": {prefix: "Diagnostic", suffix: ""},
	"FileOperationPatternKind":     {prefix: "", suffix: "Pattern"},
	"InlineCompletionTriggerKind":  {prefix: "Inline", suffix: ""},
	"InsertTextFormat":             {prefix: "", suffix: "TextFormat"},
	"LanguageKind":                 {prefix: "Lang", suffix: ""},
	"SemanticTokenModifiers":       {prefix: "Mod", suffix: ""},
	"SemanticTokenTypes":           {prefix: "", suffix: "Type"},
	"SignatureHelpTriggerKind":     {prefix: "Sig", suffix: ""},
	"SymbolTag":                    {prefix: "", suffix: "Symbol"},
	"WatchKind":                    {prefix: "Watch", suffix: ""},
}
